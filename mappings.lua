...
-- general {{{
    ...
    ["<Down>"] = { 'v:count || mode(1)[0:1] == "no" ? "j" : "gj"', "move down", opts = { expr = true } },
     ...
     ["<TAB>"] = { function() require("nvchad_ui.tabufline").tabuflineNext() end, "  下一个 buffer" },
     ["<S-Tab>"] = { function() require("nvchad_ui.tabufline").tabuflinePrev() end, "  上一个 buffer" },
...
-- }}}
    ...
    ["<leader>bn"] = { function() require("nvchad_ui.tabufline").tabuflineNext() end, "切换下个buf(tab等效)" },
    ["<leader>bp"] = { function() require("nvchad_ui.tabufline").tabuflinePrev() end, "切换上个buf(s-tab等效)" },
    ["<leader>b<TAB>"] = { function() require("nvchad_ui.tabufline").move_buf(1) end, "移动buf到下一个" },
    ["<leader>b<S-Tab>"] = { function() require("nvchad_ui.tabufline").move_buf(-1) end, "移动buf到上一个" },
    --- }}}
